...
const snapshot = { available: true, totalCommands: 362926, inputBytes: 0, outputBytes: 4096, estimatedCostUsd: 5.01, sampledAt: '2026-08-26T12:00:00.000Z', period: 'current_month' as const, source: 'upstash_management_stats' as const, alertThresholdUsd: 5, maxBudgetUsd: 20, alertTriggered: true, metrics: [] }
