...
export const MODEL_CATALOGUE: ModelOption[] = [
  ...
  { provider: 'minimax', model: 'MiniMax-M3', label: 'MiniMax M3', description: 'Platform default, current text flagship', tier: 'standard', priceIn: 0.6, priceOut: 2.4, contextK: 512, defaultBase: 'https://api.minimax.chat/v1' },
  { provider: 'minimax', model: 'MiniMax-M2.7-highspeed', label: 'MiniMax M2.7 Highspeed', description: 'A low-latency version with the same capabilities', tier: 'fast', priceIn: 0.6, priceOut: 2.4, contextK: 200, defaultBase: 'https://api.minimax.chat/v1' },
