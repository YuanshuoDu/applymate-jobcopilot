...
const metrics = ['success_rate', 'captcha_rate', 'avg_duration_ms', 'ai_error_rate', 'ai_cost_usd', 'redis_cost_usd', 'queue_stuck_jobs', 'queue_failed_jobs', 'queue_dead_letter_jobs'] as const
