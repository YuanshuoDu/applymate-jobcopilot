...
describe('candidate RLS rollout SQL', () => {
  it('keeps activation deployment-gated and covers tenant child tables', () => {
    ...
    for (const table of ['"User"', '"application_tasks"', '"application_task_events"', '"apply_results"', '"ai_budgets"', '"ai_budget_adjustments"', '"agent_sessions"', '"sub_agent_tasks"', '"support_cases"', '"support_case_messages"']) {
