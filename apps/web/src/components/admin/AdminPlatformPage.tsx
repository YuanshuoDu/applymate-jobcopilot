...
export function AdminPlatformPage({ permissions }: { permissions: readonly string[] }) {
  ...
  function editDraft(flag: FlagRow) {
    ...
    setKey(flag.key as ManagedFeatureKey)
