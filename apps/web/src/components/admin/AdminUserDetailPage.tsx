...
function planLabel(value: string, t: (key: string) => string) {
  return value === 'free' ? t('adminDetail.free') : value === 'pro' ? t('adminDetail.pro') : value === 'enterprise' ? t('adminDetail.enterprise') : value
}
