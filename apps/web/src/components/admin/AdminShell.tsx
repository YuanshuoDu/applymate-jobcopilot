...
import { Activity, BarChart3, Bell, Bot, FileText, Home, Inbox, Radio, ShieldCheck, Users } from 'lucide-react'
...
const navigation = [
  ...
  { href: '/admin/access', label: 'Access', icon: ShieldCheck, permission: 'admin_members.manage' },
]
