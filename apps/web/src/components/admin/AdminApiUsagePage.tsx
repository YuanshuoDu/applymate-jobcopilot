...
type Payload = {
  ...
  optimization?: { cacheHits: number; singleflightHits: number; providerSkips: number; shadowJobs: number; shadowNetNewJobs: number; shadowValidApplyUrls: number; shadowCompleteDescriptions: number }
