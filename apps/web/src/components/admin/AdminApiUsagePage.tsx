...
type ExternalProvider = { key: string; label: string; category: string; access: string; billing: string; telemetry: string; calls: number; inputBytes: number; outputBytes: number; cost: number; errors: number; avgLatency: number; lastEventAt: string | null; source: string; period: string | null; sampledAt: string | null; alertThresholdUsd: number | null; maxBudgetUsd: number | null; alertTriggered: boolean; operations: Array<{ operation: string; credentialSource: string; calls: number; inputBytes: number; outputBytes: number; cost: number; errors: number }> }
