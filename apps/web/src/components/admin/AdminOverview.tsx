  ...
  return <div className="admin-page">
    ...
    <div className="admin-overview">
      ...
      <div className="admin-metric-grid admin-metric-grid-wide">
        ...
        <Metric label="AI cost" value={loading ? '...' : `$${data?.ai?.estimatedCostUsd?.toFixed(4) ?? '0.0000'}`} detail={`${data?.ai?.calls ?? 0} calls · ${data?.ai?.avgLatencyMs ?? 0}ms avg`} />
      </div>
