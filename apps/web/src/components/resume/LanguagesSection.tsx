...
const LEVEL_COLOR: Record<string, string> = {
  Native: 'var(--primary)', Fluent: 'var(--primary)', Advanced: 'var(--c-success)', Intermediate: 'var(--c-warning)', Basic: 'var(--c-danger)',
}
      ...
      {!collapsed && (
        <>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {languages.map((l, i) => (
              editIdx === i ? (
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '4px 8px', border: '0.5px solid var(--primary)', borderRadius: 6, background: 'var(--bg)' }}>
            ...
            {adding && (
              <div style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '4px 8px', border: '0.5px solid var(--primary)', borderRadius: 6, background: 'var(--bg)' }}>
