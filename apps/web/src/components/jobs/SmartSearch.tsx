...
interface SearchMeta {
  ...
  apiKeys?: { rapidapi: boolean; adzuna: boolean; reed: boolean; careerjet: boolean; cleanjobdata: boolean; fantasticjobs?: boolean }
}
...
const SOURCE_STYLE: Record<string, { label: string; color: string; bg: string }> = {
  ...
  fantasticjobs: { label: 'Fantastic Jobs', color: '#7C3AED', bg: 'rgba(124,58,237,0.10)'     },
