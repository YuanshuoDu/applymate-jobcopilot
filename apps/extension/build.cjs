...
<head>
  ...
  body { width: 360px; min-width: 360px; min-height: 0; overflow: hidden; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; background: #f8f8ff; color: #101a3a; font-size: 13px; }
