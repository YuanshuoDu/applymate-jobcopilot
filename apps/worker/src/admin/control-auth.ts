...
export type ControlAction = 'queue_summary' | 'failed_queue_jobs' | 'retry_queue_job' | 'dead_letter_jobs' | 'retry_dead_letter_job' | 'pause_queue' | 'resume_queue' | 'pause_worker' | 'resume_worker' | 'apply_ats_policy'
