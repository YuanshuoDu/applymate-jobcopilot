...
const TASK_COLUMNS = `task."id", session."userId" AS "userId", task."sessionId", task."turnId", task."rootTaskId",
  ...
  task."context", task."attemptCount", task."maxAttempts", task."leaseOwner", task."leaseExpiresAt", task."interruptRequestedAt", task."result", task."failureReason"`
