...
## 11. AI model catalogue, primary default, and fallback default

### 11.1 Runtime resolution order
...
### 11.2 Catalogue lifecycle and admin actions
...
### 11.3 Endpoints, cache, and audit
...
## 12. Product plans, prices, subscriptions, and entitlement scope

### 12.1 Source of truth and compatibility
...
### 12.3 Pricing, subscription, and change workflow
...
## 13. Broadcasts to existing notifications
...
## 14. API, authorization, and Worker control contract
...
## 17. Tests and release acceptance
